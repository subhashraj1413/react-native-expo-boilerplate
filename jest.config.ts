...
const config: Config = {
  ...
  transformIgnorePatterns: [
    "node_modules/(?!((jest-)?react-native|@react-native|@react-navigation|@reduxjs/toolkit|immer|react-native-safe-area-context|react-native-screens|react-native-gesture-handler|react-redux))",
  ],
  /**
